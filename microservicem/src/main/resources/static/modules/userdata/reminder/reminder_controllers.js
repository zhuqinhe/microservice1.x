...
.controller('reminderCtrl', ['$rootScope','$scope','sharedProperties','$http','$log','loginService', '$routeParams','commonMethod','$q','$location', function($rootScope,$scope,sharedProperties,$http,$log,loginService,$routeParams,commonMethod,$q,$location) {
    ...
    $scope.getPageData = function() {
        ...
        $scope.url = sharedProperties.getServerUrl()+"/ui/v1/review/user/reminder/list?userId="+encodeURIComponent($scope.queryOptions.id)+"&name="+encodeURIComponent($scope.queryOptions.name)+"&begin="+($scope.pagingOptions.currentPage-1)*$scope.pagingOptions.pageSize+"&pageSize="+$scope.pagingOptions.pageSize;
    ...
    $scope.dodelete = function(deleteFlag) {
        ...
        deleteDialog.then(function(value) {
            ...
            var appDeleteUrl=sharedProperties.getServerUrl()+"/ui/v1/review/user/reminder/delete";//delete的restful请求
