...
.controller('commentCtrl', ['$rootScope','$scope','sharedProperties','$http','$log','loginService', '$routeParams','commonMethod','$q','$location', function($rootScope,$scope,sharedProperties,$http,$log,loginService,$routeParams,commonMethod,$q,$location) {
    ...
    $scope.getPageData = function() {
        ...
        $scope.url = sharedProperties.getServerUrl()+"/ui/v1/review/user/comment/list?userId="+encodeURIComponent($scope.queryOptions.id)+"&contentId="+encodeURIComponent($scope.queryOptions.contentId)+"&begin="+($scope.pagingOptions.currentPage-1)*$scope.pagingOptions.pageSize+"&pageSize="+$scope.pagingOptions.pageSize;
    ...
    $scope.dodelete = function(deleteFlag) {
        ...
        deleteDialog.then(function(value) {
            ...
            var appDeleteUrl=sharedProperties.getServerUrl()+"/ui/v1/review/user/comment/delete";//delete的restful请求
