...
.controller('selectMovieCtrl',['$rootScope','$scope','$q','sharedProperties','$http','movieService','$log','commonMethod','$translate', 
	...
	$scope.closeFileDlg = function() {
		if($scope.selectItem){
			...
			$scope.confirm();
		 	...
		 	commonMethod.tipDialog($rootScope.l10n.pleaseSelectItem);
		}
    }
